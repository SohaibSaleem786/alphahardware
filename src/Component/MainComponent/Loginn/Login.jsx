...
function Loginn() {
  ...
  function UserLogin() {
    ...
    axios
      .post(`https://crystalsolutions.com.pk/csorder3/login.php`, formData, {
        headers: {
      ...
      .then((response) => {
        if (response.data.error === 200) {
          ...
          setTimeout(() => {
            setAlertData(null);
            // const encryptedPath = encryptPath("/MainPage");
            // navigate(`/dynamic/${encryptedPath}`, { replace: true });
            navigate("/MainPage");
          }, 500);
        } else {
      ...
      >
        ...
        <div className="row first-row">
          ...
          <dir className="row ">
            ...
            <div className="col-sm-1 itc-logo">
              <img
                src={AC}
                alt="Logo"
            ...
            <div className="col-sm-3 itc-name">ALPHA HARDWARE</div>
            <div className="col-sm-5 itc-data">
              24/7 Customer Service Call: 0333-6965761 <br />
              alphahardware@gmail.com
            </div>
          </dir>
        </div>
        <div
